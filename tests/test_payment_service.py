...
class TestListPaymentsService:
    ...
    def test_list_payments_with_provided_session(self):
        ...
        result = list_payments_service(limit=10, db=mock_session)
    ...
    def test_list_payments_returns_formatted_list(self):
        ...
        mock_payment_1.created_at = datetime(2026, 1, 19, 10, 0, 0, tzinfo=timezone.utc)
        mock_payment_1.updated_at = datetime(2026, 1, 19, 10, 5, 0, tzinfo=timezone.utc)
        ...
        mock_payment_2.created_at = datetime(2026, 1, 19, 11, 0, 0, tzinfo=timezone.utc)
        mock_payment_2.updated_at = datetime(2026, 1, 19, 11, 0, 0, tzinfo=timezone.utc)
